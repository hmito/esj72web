...
ポスター部会の皆様には、ESJ72のWebサイト上で掲載する「一般講演」のポスターに関連する内容について執筆をお願いします。去年の原稿を基にした構成原案をお送りします。原稿を執筆の上、締め切りまでにWeb掲載依頼チャンネルにてお送りください。公開は9月下旬を予定しています。
...
英語部会の皆様には、ESJ72のWebサイト上で掲載する「一般講演」の英語口頭発表賞に関連する内容について執筆をお願いします。去年の原稿を基にした構成原案をお送りします。原稿を執筆の上、締め切りまでにWeb掲載依頼チャンネルにてお送りください。公開は9月下旬を予定しています。
...
発表編成部会の皆様には、ESJ72のWebサイト上で掲載する「一般講演」の一般講演に関連する内容について記載の確認をお願いします。去年の原稿を基にした運営部会原案をお送りします。ご確認の上、締め切りまでにWeb掲載依頼チャンネルにてお送りください。公開は9月下旬を予定しています。
...
- ポスター発表は、全てのポスターはオンライン（ONLINE CONF）で掲載していただくとともに、希望者はオンサイトでのポスター掲示が可能です。
