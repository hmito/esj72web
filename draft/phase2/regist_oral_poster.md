...
ESJ72のWebサイト上で掲載する「一般講演」のポスターに関連する内容について、Webページの執筆をお願いします。去年の原稿を基にした構成原案をお送りします。原稿を執筆の上、締め切りまでにWeb掲載依頼チャンネルにてお送りください。公開は9月下旬を予定しています。
...
ESJ72のWebサイト上で掲載する「一般講演」の英語口頭発表賞に関連する内容について、Webページの執筆をお願いします。去年の原稿を基にした構成原案をお送りします。原稿を執筆の上、締め切りまでにWeb掲載依頼チャンネルにてお送りください。公開は9月下旬を予定しています。

・Webサイト更新は、9月下旬の次は応募締切後の12月を予定しています。
・応募に際して必要な情報ですので、英語口頭発表賞の詳細については今回の原稿で可能な限りすべてご記載ください。
・原稿の情報は昨年度のままです。
・構成原案はあくまで参考ですので、適宜情報が伝わりやすいよう、編集をお願いします。
...
- 発表はオンサイトのみです。オンデマンドでの配信も行いません。
- 口頭発表には、英語セッションと通常のセッションがあります。通常のセッションにおいて英語で発表することも可能です。
- 英語セッションで口頭発表を行う学生会員または学位取得後５年以内であれば、[英語口頭発表賞](#英語口頭発表賞)の審査対象となることができます。

**ポスター発表**

- ポスター発表は、全てのポスターはオンライン（ONLINE CONF）で掲載していただくとともに、
- オンラインポスター発表の中から270件を上限とし、希望者はオンサイトでのポスター掲示が可能です。
  - オンサイトのポスター掲示で利用するパネルはA0縦置きです。演者はこのスペースを自由に利用可能です。
  - 上限件数以上のオンサイト掲示希望がある場合は学生を優先し、漏れた分は抽選による選考を想定しています。
- 博士号未取得の学生会員であれば、[ポスター発表賞](#ポスター発表賞)の審査対象となることができます。
- ポスター発表の公募セッションを選択した場合かつオンサイト発表を希望される場合、掲示場所はシンポジウム会場の近くに配置される予定です。

なお、発表件数の多寡によっては、申込時の発表形式のご希望（口頭発表かポスター発表か）に沿えない場合もあります。また、一人で複数の講演の演者になることはできず、一般講演者がシンポジウムの企画者・講演者となることもできません（共同研究者として名前を載せることは可能です）。詳細は、[重複制限](regist_information_ja/#重複制限)をご覧ください。

いずれの発表形式においても、海外からの招待者や留学生など、日本語を解さない参加者との交流のためにも、日本語の発表の場合でも一部英語併記を推奨します。

## 申込み
- 一般講演の講演者（主たる説明者、以下同様）は、日本生態学会の会員（正会員および名誉会員、以下同様）に限ります。
- 講演者は、2024年10月31日までに、大会申込サイトからから講演申込を行なうとともに、大会参加費を納入してください。
  - 講演申込には、日本語・英語両方の講演タイトル（日本語全角で40文字以内、英語半角で150文字以内）や講演者名などが必要となります。
  - 講演申込時に希望分野を選んでいただきます。一般講演申込のフォームに選択可能な分野一覧が示されますので、第３希望までお選びください。以下は講演申込のときに示される発表分野 （候補）の一覧です。なお、応募数によっては、分野が統廃合される場合もあります。
...
日本生態学会の会員で、学生 （学部、修士課程、博士課程）または 2025年3月までで学位取得後 ５年以内であることが応募条件となります。育児／介護休暇はこの５年間に含めません。過去にEPA最優秀賞を受賞した方はお申し込みいただけませんが、優秀賞を受賞した方はお申込みいただけます。なお、この応募資格は、次回大会のESJ72以降、変更になる可能性があります。
