...
・原稿の情報は昨年度のままです。
・昨年度の原稿をお送りしているのは、あくまで参考のためですので、適宜情報が伝わりやすいよう、情報の取捨選択も含めて編集をお願いします。
・会員種別毎の講演資格、および重複制限については、各種申込概要のページ（https://esj-meeting.net/regist_information_ja/）にも記載されています。それぞれ、以下のように記入することでリンクを張れます。情報過多とならないよう、記載の簡略化にご活用ください。
	[会員種別ごとの講演資格（文字は何でもよい）](regist_information_ja#会員種別ごとの講演資格)
	[重複制限（文字は何でもよい）](regist_information_ja#重複制限)
...
シンポジウムは、大会の中心となる集会です。大会参加者は、毎年多様なテーマに関するシンポジウムが開催されるとともに、これまでにはなかった新鮮なテーマのシンポジウムが開催されることを期待しています。下記の趣旨をご理解のうえ、奮ってお申込みください。
...
### フォーラムの提案
- フォーラム企画の仮提案は、2023年9月15日（金）を締切とします。申込は各委員会代表者が行ないます。
