...
## 重要なお知らせ
- **<span style="color: red; ">全ての口頭発表（英語口頭発表含む）には、[大会プラットフォーム（ONLINE CONF）](https://esj72.gakkai.online/)上への発表ファイルのアップロードが必要です！！（締切：3月7日（金曜日）23:59）</span>** シンポジウム等の各種集会での発表では、発表ファイルのアップロードは必要ありません。[詳細はこちら](for_presentation_ja#口頭発表・英語口頭発表における発表ファイル提出の方法)
