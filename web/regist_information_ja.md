...
## 講演資格について
### 会員種別ごとの講演資格
大会での講演は原則として会員（正会員および名誉会員）に限ります。非会員の方が参加可能なのは以下の3つのケースです。
- 聴講者として参加する場合
- シンポジウム企画者に招待されて講演する場合
...
- シンポジウム企画者・講演者は、他のシンポジウム、自由集会、一般公演の企画者・講演者となることはできません。
  - ただし、要旨登録を伴わない趣旨説明やコメンテータ・意見表明は、講演の重複制限の対象とはなりません。
- 自由集会企画者・講演者は、一般公演の講演者となることはできます。
- フォーラムの企画者・話題提供者は重複講演制限の対象となりません。

||シンポジウム|自由集会|一般公演|フォーラム|
|:---:|:---:|:---:|:---:|:---:|
|シンポジウム|×|×|×|〇|
|自由集会|×|×|〇|〇|
|一般公演|×|〇|×|〇|
