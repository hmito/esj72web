...
本大会では、各種集会における **オンライン発表については一律に不可** とさせていただきます。これは、本大会では発表をすべて会場に設置済みの発表用PCを用いていただく必要があること、会場における通信に制約があることから、事前にトラブルを避けるために設けられた措置です。ご理解いただきますようお願いいたします。

なお、オンサイトでの発表が困難な場合、趣旨説明、コメント、意見表明など**要旨登録を伴わない発表、およびフォーラムでの発表に限り、事前に撮影した動画を再生する形での発表を認めます**。下記のオンデマンド配信の映像にも残すことができますので、必要があればご活用ください。

### 発表の配信について

本大会では、原則すべてのシンポジウムと、希望する自由集会、フォーラム（ただし希望多数の場合は選定）の発表は録画され、後日ONLINE CONF上で公開されます。

録画トラブルを防ぐため、録画作業はすべて業者に任せています。録画は会場に設置された発表PCでのみ行うため、録画されるのはスライドと音声のみです。会場の様子や講演者の顔は映りません。質疑応答や総合討論については、マイクを通して話された内容についてのみ録音が可能です。

## シンポジウム・自由集会の企画

### 企画にあたって

- 発表は[会場に設置されている発表用PC](for_presentation_ja#共通の注意点)を使用していただきます。企画者・講演者が持ち込んだPCを使用することはできません。
...
- 要旨登録を伴わない趣旨説明やコメント、意見表明などは講演には数えません。よって、これらの形での集会参加は、非会員の方でも可能であり、重複制限の対象にもなりません。
	- ただし、上記の形で集会へ参加する場合でも、大会参加申込みが必要です。企画者は注意喚起をお願いします。
...
- 企画者は、大会申込サイトに登録された会員番号を用いて企画申込を行います。会員番号は、[マイページ](https://iap-jp.org/esj/mypage/login/login)の会員検索機能によっても調べることができます。
	- **企画者が申し込み（2024年10月31日締切）をするまでに、全ての共同企画者・講演者は[大会申込サイト](https://iap-jp.org/esj/conf/login.php)への登録をすませておく必要があります**。あらかじめ大会申込サイトにログインし、申込者情報（メールアドレス、所属先など）の登録を済ませておくよう、共同企画者・講演者全員へ周知するようにしておいてください。
...
フォーラムの企画者・講演者の手続きについては、学会事務局より提案代表者へお送りしたメールをご参照ください。
