...
なお、録画トラブルを防ぐため、録画作業はすべて業者に任せています。録画は会場に設置された発表PCでのみ行うため、録画されるのはスライドと音声のみです。会場の様子や講演者の顔は映りません。なお、質疑応答や総合討論については、マイクを通して話された内容についてのみ録音が可能です。

## シンポジウム・自由集会の企画

### 企画にあたって

- 発表は[会場に設置されている発表用PC](for_presentation_ja#オンサイト発表に関する共通事項)を使用していただきます。企画者・講演者が持ち込んだPCを使用することはできません。
