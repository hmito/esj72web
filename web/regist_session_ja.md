...
・markdown形式の細かい書き方は、説明ページ（https://github.com/hmito/esj72web/blob/main/docs/esj_web_markdown.md）をご覧ください。・Webサイト更新は、9月下旬の次は応募締切後の12月を予定しています。
・原稿の情報は昨年度のままです。
・英語版の作成もお願いいたします。
...
- それぞれの集会の位置づけ及び講演資格・他の集会や一般講演との重複制限については下記の表と説明をご覧いただいた上で、企画の申し込みを行ってください。
...
- 開催時間は180分です。
- オンサイト・オンラインでのハイブリッド形式で開催いたします。演者の方は、原則としてオンサイトで発表をしていただくことになります。
...
- 開催時間は90分です。
- 申込時にオンライン希望、ハイブリッド希望を確認いたします。ハイブリッド開催になった場合、原則として演者の方はオンサイトで発表していただくことになります。
...
- いずれの集会も企画者・講演者は生態学会員に限ります。ただし、シンポジウムに限り非会員の方に招待講演をしていただくことは可能です（[会員種別ごとの講演資格](https://esj-meeting.net/regist_information_ja/#会員種別ごとの講演資格)参照）。
- シンポジウム・自由集会の企画者・講演者は、他の集会の企画者・講演者、一般講演の講演者になることはできません。ただし、自由集会と一般講演の組み合わせのみ重複可能です（[重複制限](https://esj-meeting.net/regist_information_ja/#重複制限)参照）。
...
**[【各種講演申込みサイトへ】](https://esj-meeting.net/regist_information_ja/#各種申し込み概要)**

- シンポジウム・自由集会の応募締切は、2024年10月31日（金）23:59です。
- 企画者は、大会申込サイトに登録された会員番号を用いて企画申込を行います。会員番号は、マイページの会員検索機能によっても調べることができます。
	- **企画者が申し込みをする段階で、共同企画者・講演者（主たる説明者、以下同様）が大会申込サイトに登録をすませておく必要があります**。共同企画者・講演者はご自身の会員番号（非会員講演者の場合はログインID）を使って大会申込サイトにログインし、申込者情報（メールアドレス、所属先など）の登録をお早めにおすませください。
...
- [その他の注意点](https://esj-meeting.net/regist_information_ja/#その他注意点)もご確認の上、申込みを行ってください。

### 講演者が行なう手続き

- シンポジウム・自由集会で講演できるのは、シンポジウム招待講演者を除き生態学会員のみです。
	- 非会員の方は、[こちら](https://esj-meeting.net/regist_information_ja/#生態学会への新規入会手続き)を参考に、2024年10月31日（金）までに学会への入会申込みを行ない、2024年1月31日（火）までに学会費の納入をすませてください。
...
- 大会当日までに[大会参加手続き](https://esj-meeting.net/regist_information_ja/#大会参加申込み)を行い、参加費を納入してください（招待講演者は無料）。大会プラットフォームにスムーズにログインするために、できるだけ早い納入を推奨します。
- [その他の注意点](https://esj-meeting.net/regist_information_ja/#その他注意点)もご確認ください。
