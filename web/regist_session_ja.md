...
先日、運営部会ではESJ72のWebサイト（home_ja/）を公開し、公募セッション・ERシンポジウムの募集を掲載しています。現在は、参加申し込みを開始する9月後半に合わせて大幅なWebサイトの更新を計画しており、大会案内（会場情報等）と各種講演（集会・一般講演・高ポス）の申込み情報の掲載に向けて準備を進めています。
...
**[【各種講演申込みサイトへ】](regist_information_ja/#各種申し込み概要)**
...
- シンポジウム・自由集会で講演できるのは、シンポジウム招待講演者を除き生態学会員のみです。
	- 非会員の方は、[こちら](regist_information_ja/#生態学会への新規入会手続き)を参考に、2024年10月31日（金）までに学会への入会申込みを行ない、2024年1月31日（火）までに学会費の納入をすませてください。
