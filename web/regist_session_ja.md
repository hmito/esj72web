...
本大会では、各種集会における **オンライン発表については一律に不可** とさせていただきます。これは、本大会では発表をすべて会場に設置済みの発表用PCを用いていただく必要がある点や、会場における通信に制約があることから、事前にトラブルを避けるために設けられた措置です。ご理解いただきますようお願いいたします。

なお、オンサイトでの発表が困難な場合、趣旨説明、コメント、意見表明など**要旨登録を伴わない発表、およびフォーラムでの発表に限り、事前に撮影した動画による発表を認めます**。下記のオンデマンド配信の映像にも残すことができますので、必要があればご活用ください。

### 発表の配信について

本大会では、原則すべてのシンポジウムと、希望する自由集会、フォーラム（ただし希望多数の場合は選定）の発表は録画され、後日ONLINE CONF上で公開されます。

なお、録画トラブルを防ぐため、録画作業はすべて業者に任せています。録画は会場に設置された発表PCでのみ行うため、録画されるのははスライドと音声のみです。会場の様子や講演者の顔は映りません。なお、質疑応答や総合討論については、マイクを通して話された内容についてのみ録音が可能です。
