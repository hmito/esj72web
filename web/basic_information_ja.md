...
ESJ72では、若手研究者へのキャリア支援として、[キャリア支援相談室](career_ja#キャリ支援相談室)を大会期間中もしくは大会期間の前後に開催する予定です。また、昨年度に引き続き技術者向けの継続教育の認定単位である[CPD認定プログラム制度](career_ja#cpd認定プログラム)を設定する予定です。詳しくは[キャリア支援](career_ja)のページをご確認ください。
